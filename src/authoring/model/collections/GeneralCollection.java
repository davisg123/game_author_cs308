...
/**
 * General Collection is the abstract superclass for all collections held in the
 * game. Uses generics to share common behavior.
 * 
 * @author Arjun Jain
 * @author Kevin Li
 * @author Chris Bernt
 ...
 *
 * @param <T>
 *            The generic type of object we want to make a collection of.
 */
public abstract class GeneralCollection<T> extends Observable implements
		Iterable<T> {
