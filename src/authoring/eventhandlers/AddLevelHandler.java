...
public class AddLevelHandler implements GameHandler<Event> {
	...
	private void createLevel() {
		...
		newLevelView.setPaneSize(Integer.valueOf(myWizard.getMap().get("width").getInformation()), Integer.valueOf(myWizard.getMap().get("height").getInformation()));
		levelData.setWidth(Integer.valueOf(myWizard.getMap().get("width").getInformation()));
		levelData.setHeight(Integer.valueOf(myWizard.getMap().get("height").getInformation()));
